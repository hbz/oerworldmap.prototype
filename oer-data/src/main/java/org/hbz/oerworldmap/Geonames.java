...
public class Geonames {
	...
	private static final String DATA = "src/main/resources/countriesGeonamesId.txt";
	...
	public static void main(String[] args) throws InterruptedException, IOException, JsonLdError {
	...
	private static String convertToJsonLd(String geonamesId) throws JsonLdError,
		...
		List<Object> expanded = JsonLdProcessor
				.expand(JsonUtils.fromString(stringWriter.toString()));
		return JsonUtils.toString(ImmutableMap.of("@graph", expanded));
	}

	private static void index(String geonamesId, String jsonLd) throws FileNotFoundException,
			IOException {
		NtToEs.createIndex(NtToEs.config(), NtToEs.INDEX);
		NtToEs.indexData(geonamesId, jsonLd, NtToEs.INDEX, TYPE, null);
	}
}
